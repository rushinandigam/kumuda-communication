    ...
    <div className="min-h-screen font-sans">
      <div className="border-b border-brand-border bg-brand-soft">
        <div className="mx-auto max-w-[1280px] px-6 py-4 flex items-center gap-3">
          ...
          <h1 className="text-lg font-bold text-foreground">SMS</h1>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-[1280px] px-6 py-16">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 max-w-md text-sm text-muted-foreground">
            SMS gateway configuration and messaging will be available here soon.
            You&apos;ll be able to configure providers, templates, and send bulk SMS campaigns.
          </p>
        </div>
      </div>
    </div>
