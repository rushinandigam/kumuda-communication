...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.kkconnect.com). The route will set the
  ...
  // superadmin.kkconnect.com we want to switch to app.kkconnect.com. For any other domain
