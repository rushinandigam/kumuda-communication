...
export type ClientOptions = {
    baseUrl: 'https://app.kkconnect.com' | 'http://localhost:8000' | (string & {});
};
...
export type DograhEmbeddingsConfiguration = {
     ...
     * Model
     *
     * KK Connect-managed embedding model.
     */
    model?: string;
};
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. KK Connect maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by KK Connect from fixed values or workflow context templates.
     */
 ...
 * PresetToolParameter
 *
 * A parameter injected by KK Connect at runtime.
 */
