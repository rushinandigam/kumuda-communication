 ...
 */
export const getMpsCreditsApiV1OrganizationsUsageMpsCreditsGet = <ThrowOnError extends boolean = false>(options?: Options<GetMpsCreditsApiV1OrganizationsUsageMpsCreditsGetData, ThrowOnError>): RequestResult<GetMpsCreditsApiV1OrganizationsUsageMpsCreditsGetResponses, GetMpsCreditsApiV1OrganizationsUsageMpsCreditsGetErrors, ThrowOnError> => (options?.client ?? client).get<GetMpsCreditsApiV1OrganizationsUsageMpsCreditsGetResponses, GetMpsCreditsApiV1OrganizationsUsageMpsCreditsGetErrors, ThrowOnError>({ url: '/api/v1/organizations/usage/mps-credits', ...options });
